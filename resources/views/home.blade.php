                ...
                <div class="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
                    <div class="flex flex-wrap mx-[-15px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px] !mt-[-30px] items-center">
                        ...
                        <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full md:!px-[20px] lg:!px-[20px] xl:!px-[35px] !mt-[30px]">
                            <h2 class="xl:!text-[1.7rem] !text-[calc(1.295rem_+_0.54vw)] !leading-[1.25] !font-semibold !mb-3">О нас</h2>
                            <p class="lead !text-[1.1rem] !leading-[1.55] font-medium">Мы открылись в мае 2025 года. Из темного и пустого пространства мы сотворили чайный бар новой формации. Это место легко трансформируется из уютной чайной в гончарную мастерскую и джем-площадку.</p>
                            <p>У нас можно:</p>
                            <ul>
                                <li>Просто вайбово попить чайку самостоятельно или с друзьями</li>
                                <li>Взять чай на вынос</li>
                                <li>Купить чай и посуду (пробники к каждой покупке)</li>
                                <li>Прийти на мероприятие или провести свое</li>
                                <li>Заказать чайную церемонию</li>
                                <li>Побеседовать с чайными мастерами</li>
                                <li>Начать свой чайный путь</li>
                            </ul>
                    ...
                    <div class="flex flex-wrap mx-[-15px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px] !mt-10 xl:!mt-16 lg:!mt-16 md:!mt-16">
                        <div class="xl:w-4/12 lg:w-4/12 w-full flex-[0_0_auto] !px-[15px] max-w-full md:!px-[20px] lg:!px-[20px] xl:!px-[35px]">
                            <h2 class="xl:!text-[1.7rem] !text-[calc(1.295rem_+_0.54vw)] !leading-[1.25] !font-semibold !mb-3">Андеграунд чай`на бар
                                чай в ритме города</h2>
                        </div>
                        <!-- /column -->
                        <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] !px-[15px] max-w-full md:!px-[20px] lg:!px-[20px] xl:!px-[35px]">
                            <div class="flex flex-wrap mx-[-15px] !mt-[-30px] md:mx-[-20px] lg:mx-[-20px] xl:mx-[-35px]">
                                ...
                                <div class="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px] md:!px-[20px] lg:!px-[20px] xl:!px-[35px]">
                                    <div class="flex flex-row">
                                        <div>
                                            <span class="icon btn btn-circle btn-yellow !text-white !bg-[#28a745] border-[#28a745] hover:text-white hover:bg-[#28a745] hover:!border-[#28a745]   active:text-white active:bg-[#28a745] active:border-[#28a745] disabled:text-white disabled:bg-[#28a745] disabled:border-[#28a745] pointer-events-none !mr-4 !mt-1 !w-[2.2rem] !h-[2.2rem] !inline-flex !items-center !justify-center !text-[1rem] !leading-none !p-0 !rounded-[100%]"><span class="number text-[0.9rem] table-cell text-center align-middle font-bold mx-auto my-0">5</span></span>
                                        </div>
                                        <div>
                                ...
                                <div class="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px] md:!px-[20px] lg:!px-[20px] xl:!px-[35px]">
                                    <div class="flex flex-row">
                                        <div>
                                            <span class="icon btn btn-circle btn-yellow !text-white !bg-[#28a745] border-[#28a745] hover:text-white hover:bg-[#28a745] hover:!border-[#28a745]   active:text-white active:bg-[#28a745] active:border-[#28a745] disabled:text-white disabled:bg-[#28a745] disabled:border-[#28a745] pointer-events-none !mr-4 !mt-1 !w-[2.2rem] !h-[2.2rem] !inline-flex !items-center !justify-center !text-[1rem] !leading-none !p-0 !rounded-[100%]"><span class="number text-[0.9rem] table-cell text-center align-middle font-bold mx-auto my-0">6</span></span>
                                        </div>
                                        <div>
                ...
                <div class="container py-[4.5rem] xl:!py-24 lg:!py-24 md:!py-24">
                    <div class="flex flex-wrap mx-[-15px]">
                        <div class="xl:w-7/12 xxl:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mx-auto !text-center">
                            ...
                            <h2 class="xl:!text-[1.7rem] !text-[calc(1.295rem_+_0.54vw)] !leading-[1.25] font-semibold !tracking-[normal] !text-center !mt-2 !mb-10">Наши чайные мероприятия</h2>
                        </div>
                        <!--/column -->
                    </div>
                    <!--/.row -->
                    <div class="swiper-container nav-bottom nav-color !mb-[4.5rem] relative z-10 swiper-container-3" data-margin="30" data-dots="true" data-nav="false" data-items-lg="3" data-items-md="2" data-items-xs="1">
                        <div class="swiper overflow-visible pb-2 swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                            <div class="swiper-wrapper" id="swiper-wrapper-9f6ccb88dd6d1a5f" aria-live="off" style="cursor: grab; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 6" style="width: 410px; margin-right: 30px;">
                                    <article>
                                        <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                            <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="{{ asset('images/a1.jpg') }}" srcset="{{ asset('images/a1.jpg') }}" alt="image"><span class="bg"></span></a>
                                            ...
                                            <div class="card-body p-6">
                                                <div class="post-header">
                                                    <div class="post-category !mb-[.4rem] uppercase !tracking-[0.02rem] !text-[#aab0bc]">
                                                        <a href="#" class="hover !text-[#7cb798]" rel="category">Wedding</a>
                                                    </div>
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 !mt-1 !mb-3 !text-[1.15rem] !font-semibold !tracking-[normal]"><a class="!text-[#343f52] hover:!text-[#7cb798]" href="/blog-post">Ligula tristique quis risus</a></h2>
                                                </div>
                                                <!-- /.post-header -->
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 6" style="width: 410px; margin-right: 30px;">
                                    <article>
                                        <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                            <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="{{ asset('images/a2.jpg') }}" srcset="{{ asset('images/a2.jpg') }}" alt="image">
                                            </figure>
                                            <div class="card-body p-6">
                                                <div class="post-header">
                                                    <div class="post-category !mb-[.4rem] uppercase !tracking-[0.02rem] !text-[#aab0bc]">
                                                        <a href="#" class="hover !text-[#7cb798]" rel="category">Engagement</a>
                                                    </div>
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 !mt-1 !mb-3 !text-[1.15rem] !font-semibold !tracking-[normal]"><a class="!text-[#343f52] hover:!text-[#7cb798]" href="/blog-post">Nullam id dolor elit id nibh</a></h2>
                                                </div>
                                                <!-- /.post-header -->
                                                <div class="post-footer">
                                                    <ul class="!text-[0.75rem] !text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                                                        ...
                                                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="!text-[#aab0bc] hover:!text-[#7cb798] hover:!border-[#7cb798]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>3</a></li>
                                                    </ul>
                                                    <!-- /.post-meta -->
                                                </div>
                                                <!-- /.post-footer -->
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="3 / 6" style="width: 410px; margin-right: 30px;">
                                    <article>
                                        <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                            <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="{{ asset('images/a3.jpg') }}" srcset="{{ asset('images/a3.jpg') }}" alt="image"><span class="bg"></span></a>
                                                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                    <h5 class="from-top !mb-0  absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">Read More</h5>
                                                </figcaption>
                                            </figure>
                                            <div class="card-body p-6">
                                                <div class="post-header">
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 !mt-1 !mb-3 !text-[1.15rem] !font-semibold !tracking-[normal]"><a class="!text-[#343f52] hover:!text-[#7cb798]" href="/blog-post">16 июня - Мастер-класс по Живописи акварель+графика</a></h2>
                                                    <p>
                                                        2 группы 16.00 и 19.00
                                                ...
                                                <div class="post-footer">
                                                    <ul class="!text-[0.75rem] !text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                                                        <li class="post-date inline-block"><i class="uil uil-calendar-alt pr-[0.2rem] align-[-.05rem] before:content-['\e9ba']"></i><span>16 июня 2025</span></li>
                                                    </ul>
                                                    <!-- /.post-meta -->
                                                </div>
                                                <!-- /.post-footer -->
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="4 / 6" style="width: 410px; margin-right: 30px;">
                                    <article>
                                        <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                            <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="{{ asset('images/a4.jpg') }}" srcset="{{ asset('images/a4.jpg') }}" alt="image"><span class="bg"></span></a>
                                                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                    <h5 class="from-top !mb-0  absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">Read More</h5>
                                                </figcaption>
                                            </figure>
                                            <div class="card-body p-6">
                                                <div class="post-header">
                                                    ...
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 !mt-1 !mb-3 !text-[1.15rem] !font-semibold !tracking-[normal]"><a class="!text-[#343f52] hover:!text-[#7cb798]" href="/blog-post">Morbi leo risus porta eget</a></h2>
                                                </div>
                                                <!-- /.post-header -->
                                                <div class="post-footer">
                                                    <ul class="!text-[0.75rem] !text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                                ...
                                <!--/.swiper-slide -->
                                <div class="swiper-slide" role="group" aria-label="5 / 6" style="width: 410px; margin-right: 30px;">
                                    <article>
                                        <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                            <figure class="card-img-top overlay overlay-1 group"><a href="#"> <img src="{{ asset('images/a5.jpg') }}" srcset="{{ asset('images/a5.jpg') }}" alt="image"><span class="bg"></span></a>
                                                <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                    <h5 class="from-top !mb-0  absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">Read More</h5>
                                                </figcaption>
                                            </figure>
                                            <div class="card-body p-6">
                                                <div class="post-header">
                                                    <div class="post-category !mb-[.4rem] uppercase !tracking-[0.02rem] !text-[#aab0bc]">
                                                        <a href="#" class="hover !text-[#7cb798]" rel="category">Couples</a>
                                                    </div>
                                                    <!-- /.post-category -->
                                                    <h2 class="post-title h3 !mt-1 !mb-3 !text-[1.15rem] !font-semibold !tracking-[normal]"><a class="!text-[#343f52] hover:!text-[#7cb798]" href="/blog-post">Nulla vitae elit libero</a></h2>
                                                </div>
                                                <!-- /.post-header -->
                                                <div class="post-footer">
                                                    <ul class="!text-[0.75rem] !text-[#aab0bc] m-0 p-0 list-none flex  !mb-0">
                                                        ...
                                                        <li class="post-comments inline-block before:content-[''] before:inline-block before:w-[0.2rem] before:h-[0.2rem] before:opacity-50 before:m-[0_.6rem_0] before:rounded-[100%] before:align-[.15rem] before:bg-[#aab0bc]"><a class="!text-[#aab0bc] hover:!text-[#7cb798] hover:!border-[#7cb798]" href="#"><i class="uil uil-comment pr-[0.2rem] align-[-.05rem] before:content-['\ea54']"></i>1</a></li>
                                                    </ul>
                                                    <!-- /.post-meta -->
                                                </div>
                                                <!-- /.post-footer -->
                        ...
                        <!-- /.swiper -->
                        <div class="swiper-controls"><div class="swiper-navigation"><div class="swiper-button swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-9f6ccb88dd6d1a5f" aria-disabled="true"></div><div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-9f6ccb88dd6d1a5f" aria-disabled="false"></div></div></div></div>
                    <!-- /.swiper-container -->
                </div>
                <!-- /.container -->
            </div>
                    ...
                    <div class="itemgrid grid-view projects-masonry">
                        ...
                        <div class="flex flex-wrap mx-[-15px] md:mx-[-15px] !mt-[-30px] isotope">
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full drinks events">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="{{ asset('images/img.png') }}" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/img.png') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full events">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf2-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf2.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full drinks red">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf3-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf3.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <!-- /.project -->
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full events">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf4-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf4.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full pastries events">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf5-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf5.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full red">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf6-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf6.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full red drinks">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf7-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf7.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full pastries">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf8-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf8.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <!-- /.project -->
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full events">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf9-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf9.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <!-- /.project -->
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full red">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf10-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf10.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full drinks">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf11-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf11.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <!-- /.project -->
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full red">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf12-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf12.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                            ...
                            <!-- /.project -->
                            <div class="project item xl:w-4/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] !mt-[30px] max-w-full drinks">
                                <figure class="overlay overlay-1 rounded group relative"><a class="relative block z-[3] cursor-pointer inset-0" href="./assets/img/photos/pf13-full.jpg" data-glightbox="" data-gallery="shots-group"> <img src="{{ asset('images/pf13.jpg') }}" alt="image"></a>
                                    <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                        <h5 class="from-top !mb-0 absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">Ultricies Aenean</h5>
                                    </figcaption>
                                </figure>
                                    ...
                                    <div class="item-inner">
                                        <div class="card border-0 !bg-[rgba(255,255,255,.9)]">
                                            <div class="card-body flex-[1_1_auto] p-[40px]">
                                                ...
                                                <blockquote class="border-0 !mb-0 !text-[.9rem] !leading-[1.7] font-medium m-[0_0_1rem]">
                    ...
                    <div class="flex flex-wrap mx-[-15px] xl:mx-0 lg:mx-0 !mt-[-50px] items-center">
                        <div class="xl:w-6/12 lg:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:px-0 lg:px-0 !mt-[50px]">
                            <div class="flex flex-wrap mx-[-15px] !mt-[-30px] !text-center">
                                <div class="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                                    <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] !mb-6">
                                        <figure class="card-img-top overlay overlay-1 group">
                                            <a href="#"><img class="max-w-full h-auto" src="{{ asset('images/fs4.jpg') }}" alt="image"></a>
                                            <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                <h5 class="from-top !mb-0 absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">View Gallery</h5>
                                            </figcaption>
                                        </figure>
                                        <div class="card-body p-4">
                                            <h3 class="h4  !mb-0">Чай</h3>
                                        </div>
                                        <!--/.card-body -->
                                    </div>
                                    <!-- /.card -->
                                    <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                        <figure class="card-img-top overlay overlay-1 group">
                                            <a href="#"><img class="max-w-full h-auto" src="{{ asset('images/fs6.jpg') }}" alt="image"></a>
                                            <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                <h5 class="from-top !mb-0 absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">Посмотреть</h5>
                                            </figcaption>
                                        </figure>
                                        <div class="card-body p-4">
                                            <h3 class="h4  !mb-0">Церемонии</h3>
                                        </div>
                                        <!--/.card-body -->
                                    </div>
                                    <!-- /.card -->
                                ...
                                <!-- /column -->
                                <div class="xl:w-6/12 lg:w-6/12 md:w-6/12 w-full flex-[0_0_auto] !px-[15px] max-w-full !mt-[30px]">
                                    <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)] xl:!mt-6 lg:!mt-6 md:!mt-6 !mb-6">
                                        <figure class="card-img-top overlay overlay-1 group">
                                            <a href="#"><img class="max-w-full h-auto" src="{{ asset('images/fs5.jpg') }}" alt="image"></a>
                                            <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                <h5 class="from-top !mb-0 absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">View Gallery</h5>
                                            </figcaption>
                                        </figure>
                                    ...
                                    <div class="card !shadow-[0_0.25rem_1.75rem_rgba(30,34,40,0.07)]">
                                        <figure class="card-img-top overlay overlay-1 group">
                                            <a href="#"><img class="max-w-full h-auto" src="{{ asset('images/fs7.jpg') }}" alt="image"></a>
                                            <figcaption class="group-hover:opacity-100 absolute w-full h-full opacity-0 text-center px-4 py-3 inset-0 z-[5] pointer-events-none p-2">
                                                <h5 class="from-top !mb-0 absolute w-full translate-y-[-80%] px-4 py-3 left-0 top-2/4 group-hover:-translate-y-2/4">View Gallery</h5>
                                            </figcaption>
                                        </figure>
                        ...
                        <div class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] !px-[15px] max-w-full xl:!ml-[8.33333333%] lg:!ml-[8.33333333%] xl:px-0 lg:px-0 !mt-[50px]">
                            <h2 class="xl:!text-[1.7rem] !text-[calc(1.295rem_+_0.54vw)] !leading-[1.25] !font-semibold !mb-3">Услуги</h2>
                            <p class="lead !text-[1.1rem] !leading-[1.55] font-medium">I would like to give you a unique photography experience, capture your products with excellent composition and lighting skills.</p>
                            ...
                            <a href="#" class="btn btn-green !text-white !bg-[#28a745] border-[#28a745] hover:text-white hover:bg-[#28a745] hover:!border-[#28a745]   active:text-white active:bg-[#28a745] active:border-[#28a745] disabled:text-white disabled:bg-[#28a745] disabled:border-[#28a745] !rounded-[50rem] !mt-2 hover:translate-y-[-0.15rem] hover:shadow-[0_0.25rem_0.75rem_rgba(30,34,40,0.15)]">Подробнее</a>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
